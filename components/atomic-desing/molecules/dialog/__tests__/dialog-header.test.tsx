...
jest.mock("@/components/atomic-desing/atoms/typography", () => {
  ...
  return {
    Typography: ({
      ...
      return (
        <span data-testid="custom-text" data-variant={variant} data-color={color} {...props}>
          {children}
        </span>
      );
    },
...
describe("DialogHeader", () => {
  ...
  describe("Casos edge y contenido especial", () => {
    ...
    it("debería manejar títulos y descripciones largos", () => {
      const longTitle =
        "Este es un título muy largo que podría causar problemas de renderizado si no se maneja correctamente en el componente";
      const longDescription =
        "Esta es una descripción extremadamente larga que contiene mucha información y podría causar problemas de layout o renderizado si el componente no está preparado para manejar textos de esta longitud";

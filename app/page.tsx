      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            ...
            >
              <Typography variant="body" color="secondary">
                Automatización de despliegues, contenedores y infraestructura
                en la nube para aplicaciones escalables.
              </Typography>
            </Card>
          </div>
          ...
          <Card 
            title="Herencia de Componentes"
            subtitle="Atomic Design ahora hereda de shadcn/ui con funcionalidades adicionales"
            variant="elevated"
            className="mt-8"
          >
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <div className="px-2 py-1 bg-primary text-primary-foreground rounded-md text-sm">
                    Disponible
                  </div>
                  <div className="px-2 py-1 border rounded-md text-sm">
                    Remoto
                  </div>
                </div>
              </div>
